			...
			<Container>
				<div className="max-w-4xl mx-auto text-center space-y-16">
					<div className="space-y-6">
						...
						<p className="text-xl text-white/90 leading-loose tracking-wide max-w-3xl mx-auto">
					...
					<div className="space-y-12">
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
							<div className="space-y-4">
								...
								<p className="leading-loose tracking-wide text-white/80 text-sm">
					...
					<div className="space-y-6 pt-8 border-t border-white/10">
						<p className="text-lg leading-loose tracking-wide text-white/85">
