...
const VolunteerActivityFilterTab = memo(
	({
		selectedStatus,
		statusChangeAction,
		searchQuery,
		...
		const searchInput = useMemo(
			...
			[localSearchQuery, handleSearchChange, handleClearSearch],
		)
		...
		const statusFilter = useMemo(
			...
			[selectedStatus, statusChangeAction, filterOptions],
		)
...
VolunteerActivityFilterTab.displayName = 'VolunteerActivityFilterTab'

export default VolunteerActivityFilterTab
