...
export interface LinearTimelineEntry {
	id?: string
	title: string
...
interface LinearTimelineProps {
	data: LinearTimelineEntry[]
	className?: string
}

const LinearTimeline = React.memo(
	({ data, className }: LinearTimelineProps) => {
...
LinearTimeline.displayName = 'LinearTimeline'

export { LinearTimeline }
