...
const LinearTagCloud = forwardRef<HTMLDivElement, LinearTagCloudProps>(
...
LinearTagCloud.displayName = 'LinearTagCloud'

export { LinearTag, LinearTagCloud, linearTagVariants }
