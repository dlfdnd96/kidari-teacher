...
import { Card, LinearCardContent } from './card'
import { LinearText } from './typography'
...
const Testimonials = forwardRef<HTMLDivElement, LinearTestimonialsProps>(
	(
		...
		const validatedTestimonials = useMemo(() => {
			if (!Array.isArray(testimonials)) {
				console.warn('Testimonials: testimonials prop must be an array')
				return []
			}
...
export { Testimonials, LinearTestimonialCard }
