...
import { LinearTextMuted } from './linear-typography'
...
const LinearFooter = forwardRef<HTMLElement, LinearFooterProps>(
	(
		{
			className,
...
LinearFooter.displayName = 'LinearFooter'
...
export { LinearFooter, LinearSimpleFooter }
